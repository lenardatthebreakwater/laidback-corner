...
A blog application written in Python using the Flask webframework. For testing I used Sqlite as the database while for the deployed version I used PostgreSQL.
